...
#Purpose
This is the root readme and details how I approached each question in the data science practical exam. Every question is in its own folder that contains the data and code relevant to that question. The data is not commited to github. 
